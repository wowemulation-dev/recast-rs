use crate::{dynamic_tile::DynamicTile, colliders::Collider};
...
impl JobProcessor {
    ...
    pub fn add_collider(&mut self, collider_id: u64, collider: Arc<dyn Collider>, affected_tiles: Vec<(i32, i32)>) {
        let job = ColliderAdditionJob::new(collider_id, collider, affected_tiles.into_iter().collect());
    ...
    pub fn rebuild_tile(&mut self, coords: (i32, i32), force_full_rebuild: bool) {
        ...
        log::info!("Tile rebuild requested for {:?}, full_rebuild: {}", coords, force_full_rebuild);
    }
}
...
mod tests {
    ...
    fn test_job_processing() {
        ...
        tiles.insert((0, 0), DynamicTile::new(
            0, 0,
