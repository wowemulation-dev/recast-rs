...
[![Crates.io](https://img.shields.io/crates/v/waymark-dynamic.svg)](https://crates.io/crates/waymark-dynamic)
[![Documentation](https://docs.rs/waymark-dynamic/badge.svg)](https://docs.rs/waymark-dynamic)
[![License](https://img.shields.io/crates/l/waymark-dynamic.svg)](../LICENSE-MIT)
...
```bash
cargo build --target wasm32-unknown-unknown -p waymark-dynamic
```
