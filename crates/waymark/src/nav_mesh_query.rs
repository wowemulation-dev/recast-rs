...
impl<'a> NavMeshQuery<'a> {
    ...
    pub fn closest_point_on_poly(
        ...
        for i in 0..poly.vert_count as usize {
            ...
            let edge_closest_pt =
                landmark_common::closest_point_on_segment(&pos_pt, &vi_pt, &vj_pt);
    ...
    fn closest_point_on_off_mesh_connection(
        ...
        let closest_pt = landmark_common::closest_point_on_segment(&pos_pt, &start_pt, &end_pt);
    ...
    pub fn move_along_surface(
        ...
        use landmark_common::{dist_point_segment_sqr_2d_with_t, point_in_polygon_2d};
    ...
    pub fn find_polys_around_shape(
        ...
        use landmark_common::intersect_segment_poly_2d;
    ...
    pub fn closest_point_on_poly_boundary(
        ...
        use landmark_common::distance_pt_poly_edges_sqr;
