...
[![Crates.io](https://img.shields.io/crates/v/landmark-cli.svg)](https://crates.io/crates/landmark-cli)
[![License](https://img.shields.io/crates/l/landmark-cli.svg)](../LICENSE-MIT)

## Overview

`landmark-cli` provides command-line access to Recast navigation mesh generation
...
```bash
cargo install landmark-cli
```

Or build from source:

```bash
cargo build --release -p landmark-cli
```
...
```bash
landmark-cli build --input terrain.obj --output terrain.nav
```
...
```bash
landmark-cli find-path --mesh terrain.nav --start 0,0,0 --end 10,0,10
```
